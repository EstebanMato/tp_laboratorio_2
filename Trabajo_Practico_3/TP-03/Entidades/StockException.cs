...
namespace Entidades
{
    ...
    public class StockException : Exception
    {
        ...
        public StockException(string mensaje, string clase, string metodo)
            : base(mensaje)
        {
        ...
        public StockException(string mensaje, string clase, string metodo, Exception innerException)
